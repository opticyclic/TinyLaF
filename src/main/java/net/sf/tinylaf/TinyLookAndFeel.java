...
public class TinyLookAndFeel extends MetalLookAndFeel {
	...
	public void initialize() {
		...
		if(!isInstalled) {
			...
			UIManager.installLookAndFeel(new UIManager.LookAndFeelInfo(
				"TinyLookAndFeel", "net.sf.tinylaf.TinyLookAndFeel"));
		}
	...
	protected void initClassDefaults(UIDefaults table) {
		...
		table.putDefaults(new Object[] {
			"ButtonUI", "net.sf.tinylaf.TinyButtonUI",
			"CheckBoxUI", "net.sf.tinylaf.TinyCheckBoxUI",
			"TextFieldUI", "net.sf.tinylaf.TinyTextFieldUI",
			"TextAreaUI", "net.sf.tinylaf.TinyTextAreaUI",
			...
			// in v1.4.0
			"FormattedTextFieldUI", "net.sf.tinylaf.TinyFormattedTextFieldUI",
			"PasswordFieldUI", "net.sf.tinylaf.TinyPasswordFieldUI",
			"EditorPaneUI", "net.sf.tinylaf.TinyEditorPaneUI",
			"TextPaneUI", "net.sf.tinylaf.TinyTextPaneUI",
			"SliderUI", "net.sf.tinylaf.TinySliderUI",
			"SpinnerUI", "net.sf.tinylaf.TinySpinnerUI",
			"ToolBarUI", "net.sf.tinylaf.TinyToolBarUI",			
			"ToolBarSeparatorUI", "net.sf.tinylaf.TinyToolBarSeparatorUI",
			"MenuBarUI", "net.sf.tinylaf.TinyMenuBarUI",
			"MenuUI", "net.sf.tinylaf.TinyMenuUI",
			"MenuItemUI", "net.sf.tinylaf.TinyMenuItemUI",
			"CheckBoxMenuItemUI", "net.sf.tinylaf.TinyCheckBoxMenuItemUI",
			"RadioButtonMenuItemUI", "net.sf.tinylaf.TinyRadioButtonMenuItemUI",
			"ScrollBarUI", "net.sf.tinylaf.TinyScrollBarUI",
			"TabbedPaneUI", "net.sf.tinylaf.TinyTabbedPaneUI",
			"ToggleButtonUI", "net.sf.tinylaf.TinyButtonUI",
			"ScrollPaneUI", "net.sf.tinylaf.TinyScrollPaneUI",
			"ProgressBarUI", "net.sf.tinylaf.TinyProgressBarUI",
			"InternalFrameUI", "net.sf.tinylaf.TinyInternalFrameUI",
			"RadioButtonUI", "net.sf.tinylaf.TinyRadioButtonUI",
			"ComboBoxUI", "net.sf.tinylaf.TinyComboBoxUI",
			"PopupMenuSeparatorUI", "net.sf.tinylaf.TinyPopupMenuSeparatorUI",
			"SeparatorUI", "net.sf.tinylaf.TinySeparatorUI",
			"SplitPaneUI", "net.sf.tinylaf.TinySplitPaneUI",
			"FileChooserUI", "net.sf.tinylaf.TinyFileChooserUI",
			"ListUI", "net.sf.tinylaf.TinyListUI",
			"TreeUI", "net.sf.tinylaf.TinyTreeUI",
			"LabelUI", "net.sf.tinylaf.TinyLabelUI",
			"TableUI", "net.sf.tinylaf.TinyTableUI",
			"TableHeaderUI", "net.sf.tinylaf.TinyTableHeaderUI",
			"ToolTipUI", "net.sf.tinylaf.TinyToolTipUI",
			"RootPaneUI", "net.sf.tinylaf.TinyRootPaneUI",
			"DesktopPaneUI", "net.sf.tinylaf.TinyDesktopPaneUI"
			});
	}
	...
	public static ImageIcon loadIcon(final String fileName) {
		...
		if(fileName.indexOf("/") != -1) {
			url = Thread.currentThread().getContextClassLoader().getResource(
				"net/sf/tinylaf/" + fileName);
		}
		else {
			url = Thread.currentThread().getContextClassLoader().getResource(
				"net/sf/tinylaf/icons/" + fileName);
		}
