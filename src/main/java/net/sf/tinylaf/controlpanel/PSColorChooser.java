...
public class PSColorChooser extends JDialog {
	...
	private static BufferedImage loadBrightmask() {
		ImageIcon img = loadImageIcon("/net/sf/tinylaf/cp_icons/brightmask.png");
